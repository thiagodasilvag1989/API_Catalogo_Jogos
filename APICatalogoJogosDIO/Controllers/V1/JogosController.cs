using APICatalogoJogosDIO.Exceptions;
...
namespace APICatalogoJogosDIO.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromRoute] double preço)
        {
            try
            {
                await _jogoService.Atualizar(idJogo, preço);
